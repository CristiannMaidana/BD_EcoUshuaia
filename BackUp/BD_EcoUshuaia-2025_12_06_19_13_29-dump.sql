...
ALTER TABLE IF EXISTS ONLY public.estados DROP CONSTRAINT IF EXISTS estados_id_tipo_estado_fkey;
ALTER TABLE IF EXISTS ONLY public.estados DROP CONSTRAINT IF EXISTS estados_id_sensor_fkey;
...
ALTER TABLE IF EXISTS ONLY public.tipo_estados DROP CONSTRAINT IF EXISTS tipo_estados_pkey;
...
ALTER TABLE IF EXISTS public.tipo_estados ALTER COLUMN id_tipo_estado DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.estados ALTER COLUMN id_estado DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.tipo_estados_id_tipo_estado_seq;
DROP TABLE IF EXISTS public.tipo_estados;
...
--
-- Name: estados; Type: TABLE; Schema: public; Owner: Crist
--
...
ALTER TABLE public.estados OWNER TO "Crist";
...
--
-- Name: tipo_estados; Type: TABLE; Schema: public; Owner: Crist
--

CREATE TABLE public.tipo_estados (
    id_tipo_estado integer NOT NULL,
    nombre_estados character varying(50)
);


ALTER TABLE public.tipo_estados OWNER TO "Crist";

--
-- Name: tipo_estados_id_tipo_estado_seq; Type: SEQUENCE; Schema: public; Owner: Crist
--

CREATE SEQUENCE public.tipo_estados_id_tipo_estado_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.tipo_estados_id_tipo_estado_seq OWNER TO "Crist";

--
-- Name: tipo_estados_id_tipo_estado_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Crist
--

ALTER SEQUENCE public.tipo_estados_id_tipo_estado_seq OWNED BY public.tipo_estados.id_tipo_estado;
...
--
-- Name: estados id_estado; Type: DEFAULT; Schema: public; Owner: Crist
--
...
--
-- Name: tipo_estados id_tipo_estado; Type: DEFAULT; Schema: public; Owner: Crist
--

ALTER TABLE ONLY public.tipo_estados ALTER COLUMN id_tipo_estado SET DEFAULT nextval('public.tipo_estados_id_tipo_estado_seq'::regclass);
...
7	Contenedor 01	rojo	\N	2025-12-06	\N	\N	\N	\N	\N	0101000020E6100000CA61FEA5AE1551C00546DB45E2694BC0
\.
...
--
-- Data for Name: estados; Type: TABLE DATA; Schema: public; Owner: Crist
--

COPY public.estados (id_estado, fecha_estado, volumen, id_sensor, id_tipo_estado) FROM stdin;
\.
...
COPY public.residuos (id_residuo, nombre, imagen, categoria, peso, instruccion_reciclado, descripcion) FROM stdin;
1	Plastico	\N	Reciclable	0.02	Lavar y secar antes de reciclar. No incluir plásticos contaminados con alimentos o químicos.	Envases y objetos de plástico que pueden ser reciclados, como botellas, bolsas y recipientes.
2	Papel y Cartón	\N	Reciclable	0.03	Mantener seco y limpio para reciclar.	Papel de diario, revistas, cartones y cajas para reciclar.
3	Vidrio	\N	Reciclable	0.05	No romper botellas. Lavar antes de reciclar.	Botellas y frascos de vidrio reciclables.
4	Metales	\N	Reciclable	0.04	Vaciar y limpiar latas.	Latas de aluminio, latas de conserva y otros metales reciclables.
5	Orgánico	\N	Orgánico	0.10	Separar restos de comida y materia biodegradable.	Residuos biodegradables y restos de alimentos.
6	Residuos electrónicos	\N	Especial	0.15	No tirar en contenedores comunes. Llevar a puntos especiales de reciclaje.	Aparatos eléctricos y electrónicos en desuso.
7	Textiles	\N	Especial	0.08	Ropa y telas limpias para reciclaje o donación.	Ropa, telas y calzado para reciclar o reutilizar.
8	Residuos peligrosos	\N	Peligroso	0.01	Llevar a puntos especiales. No mezclar con otros residuos.	Pilas, baterías, medicamentos y productos químicos.
9	Residuos voluminosos	\N	Especial	0.20	No tirar en contenedores comunes. Llevar a puntos de recolección específicos.	Muebles, electrodomésticos, grandes, colchones, y otros objetos voluminosos.
10	Residuos de construcción y demolición	\N	Especial	0.25	No mezclar con residuos domésticos. Llevar a centros especializados.	Escombos, restos de obras, materiales como ladrillos, cemento, yeso.
11	Residuos sanitarios	\N	Peligroso	0.05	Manipular con cuidado. Llevar a centros de gestión sanitaria autorizados.	Material médico descartable, jeringas, gasas, y otros residuos hospitalarios
\.
...
--
-- Data for Name: tipo_estados; Type: TABLE DATA; Schema: public; Owner: Crist
--

COPY public.tipo_estados (id_tipo_estado, nombre_estados) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.contenedores_id_contenedor_seq', 7, true);
...
--
-- Name: tipo_estados_id_tipo_estado_seq; Type: SEQUENCE SET; Schema: public; Owner: Crist
--

SELECT pg_catalog.setval('public.tipo_estados_id_tipo_estado_seq', 1, false);
...
--
-- Name: estados estados_pkey; Type: CONSTRAINT; Schema: public; Owner: Crist
--
...
--
-- Name: tipo_estados tipo_estados_pkey; Type: CONSTRAINT; Schema: public; Owner: Crist
--

ALTER TABLE ONLY public.tipo_estados
    ADD CONSTRAINT tipo_estados_pkey PRIMARY KEY (id_tipo_estado);
...
--
-- Name: estados estados_id_sensor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Crist
--
...
--
-- Name: estados estados_id_tipo_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Crist
--

ALTER TABLE ONLY public.estados
    ADD CONSTRAINT estados_id_tipo_estado_fkey FOREIGN KEY (id_tipo_estado) REFERENCES public.tipo_estados(id_tipo_estado);
